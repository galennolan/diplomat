...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
 <h1 class="h3 mb-0 text-gray-800">Team Report Efektivitas Area
</h1>
 </div>
<hr>
<form id="dailyreport-form" method="POST" action="{{ route('reportefektivitas.penjualan') }}">
  @csrf <div class="row g-2">
                  ...
                  <div class="form-floating">
                    ...
                    <?php if ($area == 'Solo1'): ?>
                        <option value="Solo1" selected>Solo1</option>
                    <?php elseif ($area == 'Solo2'): ?>
                        <option value="Solo2" selected>Solo2</option>
                    <?php elseif ($area == 'Yogyakarta1'): ?>
                        <option value="Yogyakarta1" selected>Yogyakarta1</option>
                    <?php elseif ($area == 'Yogyakarta2'): ?>
                        <option value="Yogyakarta2" selected>Yogyakarta2</option>
