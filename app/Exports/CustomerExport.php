...
class CustomerExport implements FromQuery, WithHeadings
{
    ...
    public function query()
    {
        ...
        $end_date = date('Y-m-d 23:59:00', strtotime(request()->input('tanggalakhir')));
        ...
        ->select(
            ...
            'customer.pernahrasa as `Diplomat Mild`', 
        ...
        ->whereBetween('customer.created_at', [$start_date, $end_date]);
